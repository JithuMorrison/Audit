  ...
  return (
    <div className="bg-white">
      ...
      <header className="bg-gradient-to-r from-blue-700 to-blue-900 fixed top-0 left-0 w-full z-50 shadow-md">
        <div className="max-w-7xl mx-auto flex justify-between items-center p-4">
          ...
          <div className="flex items-center">
            <button onClick={handleRegister} className="text-white mr-4 hover:text-blue-200">
              <FaUserTie className="h-6 w-6" />
            </button>
            <button onClick={handleLogin} className="text-white hover:text-blue-200">
      ...
      <section id="hero" className="h-screen bg-gradient-to-br from-blue-700 to-blue-900 flex flex-col justify-center items-center text-white text-center px-6 pt-16">
        ...
        <button className="px-8 py-4 bg-white text-blue-700 font-bold rounded-lg shadow-lg hover:bg-blue-100 transition">
          Get Started
        </button>
      </section>
